...
densePE = load('inloc/shortlists/densePE_top100_shortlist_cvpr18')
inloc = load('inloc/shortlists/densePV_top10_shortlist_cvpr18')
dense_ncnet=load('inloc/shortlists/ncnet_shortlist_neurips18.mat');
sparse_ncnet_1600_hard=load('inloc/shortlists/sparsencnet_shortlist_1600_hard.mat');
sparse_ncnet_3200_hard_soft=load('inloc/shortlists/sparsencnet_shortlist_3200_hard_soft.mat');
dualrcnet_1600_partial = load('inloc/shortlists/dualrcnet_1600_partial.mat')
...
method = struct();
i=1
method(i).ImgList = dualrcnet_1600_partial.ImgList;
method(i).description = 'InLoc + DualRC-Net';
method(i).marker = 'D--';
method(i).color = 'red';
method(i).ms = 8
i=i+1
method(i).ImgList = sparse_ncnet_3200_hard_soft.ImgList;
method(i).description = 'InLoc + Sparse-NCNet';
method(i).marker = '-';
